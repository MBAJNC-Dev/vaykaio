...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Welcome to VaykAIo! Your account is ready.');
      navigate('/dashboard');
    } catch (error) {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-20 px-4 bg-gradient-to-br from-slate-50 to-sky-50">
      <Helmet>
        <title>Sign Up | VaykAIo</title>
      </Helmet>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="text-2xl font-bold bg-gradient-to-r from-slate-800 to-sky-600 bg-clip-text text-transparent">
              VaykAIo
            </span>
          </div>
        </div>
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>Start planning your next adventure with AI by your side.</CardDescription>
          </CardHeader>
          <CardContent>
